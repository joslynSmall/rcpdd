...
public class CodeGenerator {
    ...
    // 数据库 URL
//    private static final String URL = "jdbc:mysql://127.0.0.1:3306/taobao_order?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    private static final String URL = "jdbc:mysql://192.168.0.111:3306/bgms_app_test?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
//    private static final String USERNAME = "bmgs";
    private static final String USERNAME = "bgms_test";
    // 数据库密码
//    private static final String PASSWORD = "qazwsx7410";
    private static final String PASSWORD = "bgms_test";
    // @author 值
    private static final String AUTHOR = "Joslyn";
    // 包的基础路径
//    private static final String BASE_PACKAGE_URL = "cc.mrbird.febs";
    private static final String BASE_PACKAGE_URL = "com.xsy.bgms.modules.userCentre";
    // xml文件路径
